...
## Corpus Check
- 150 files · ~1,632,252 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 378 nodes · 369 edges · 100 communities (95 shown, 5 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.6)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `df3b2263`
...
- **Why does `cn()` connect `Community 0` to `Community 8`, `Community 5`, `Community 7`?**
