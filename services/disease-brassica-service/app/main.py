...
app = FastAPI(title="disease-brassica-service", dependencies=[Depends(verify_internal_token)])

try:
    model = YOLO('../../models/brassica-disease/best.pt')
...
@app.get("/health")
def health():
    return {"status": "ok", "service": "disease-brassica-service"}
