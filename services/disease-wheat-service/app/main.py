...
app = FastAPI(title="disease-wheat-service", dependencies=[Depends(verify_internal_token)])

try:
    model = YOLO('../../models/wheat-disease/best.pt')
...
@app.get("/health")
def health():
    return {"status": "ok", "service": "disease-wheat-service"}
